...
urlpatterns = [
    ...
    path('auth/instagram/deletion-status/', InstagramDeletionStatusView.as_view(), name='instagram-deletion-status'),
    ...
    path('creator/payout-request/', CreatorPayoutRequestView.as_view(), name='creator-payout-request'),
